...
/**
 * A319541 Triangle read by rows: T(n,k) is the number of binary rooted trees with n leaves of exactly k colors 
...
public class A319541 extends Triangle {
  ...
  */
  ...
  protected Z compute(int n, int k) {
    ...
    Z sum = Z.ZERO;
    for (int i = 0; i <= k; ++i) {
      final Z term = Binomial.binomial(k, i).multiply(A319539.mA.get(n, k - i));
