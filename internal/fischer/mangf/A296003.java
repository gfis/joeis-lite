...
/**
 * A296003 a(n) = a(0)*b(n-1) + a(1)*b(n-2) + ... + a(n-1)*b(0), where a(0) = 2, a(1) = 4, b(0) = 1, and (a(n)) and (b(n)) are increasing complementary sequences.
...
public class A296003 extends ComplementaryEquationSequence {
  ...
  public A296003(final int hereSeqNo, final String matrix, final String[] initTerms) {
