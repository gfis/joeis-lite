...
public class A256293 implements Sequence {
  ...
  private int mN;
  private int mBase;
  private StringBuilder mReplacements;
  private boolean mBack10;
  ...
  public A256293(final int base, final boolean back10) {
    ...
    for (int i = 1; i < base; ++i) {
      mReplacements.append(String.valueOf(i));
    }
  ...
  @Override
  public Z next() {
    StringBuilder sb = new StringBuilder(Integer.toString(++mN, mBase));
