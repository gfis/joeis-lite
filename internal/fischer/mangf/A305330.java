...
/**
 * A305330 Solution (a(n)) of the complementary equation a(n) = 2*a(n-1) - a(n-2) + b(n-1) + b(n)
...
public class A305330 extends ComplementaryEquationSequence {
  ...
  public A305330(final int hereSeqNo, final String matrix, final String[] initTerms) {
