...
/**
 * A140901 Number of 3 X 5 matrices with elements in 0..n with each row and each column in nondecreasing order. 
...
public class A140901 extends HolonomicRecurrence {
  ...
  public A140901(final int offset, final int rows, final int cols) {
    super(offset, new ArrayList<Z[]>(), new Z[] { Z.ONE }, 0);
    mN = offset - 1;
    mRows = rows;
    mCols = cols;
  ...
  public static void main(final String[] args) {
    ...
    A140901 seq = new A140901(0, rows, cols);
