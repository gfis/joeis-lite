...
/**
 * A295621 a(n) = a(n-1) + 3*a(n-2) -2*a(n-3) - 2*a(n-4) + b(n-4), where a(0) = 1, a(1) = 2, a(2) = 3, a(3) = 4, b(0) = 5, b(1) = 6, b(2) = 7, b(3) = 8, and (a(n)) and (b(n)) are increasing complementary sequences.
...
public class A295621 extends ComplementaryEquationSequence {
  ...
  public A295621(final int hereSeqNo, final String matrix, final String[] initTerms) {
