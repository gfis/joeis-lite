...
/**
 * A305329 Solution (a(n)) of the complementary equation a(n) = 2*a(n-1) - a(n-2) + b(n-2)
...
public class A305329 extends ComplementaryEquationSequence {
  ...
  public A305329(final int hereSeqNo, final String matrix, final String[] initTerms) {
