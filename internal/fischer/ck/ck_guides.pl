    ...
    if ($line =~ m{\A\=(\w)\=}) {
        ...
        if ($opt !~ m{[$asel]}) {
            ...
            ($opt, $aseqno, $uv, $a , $b , $c , $d , $e , $f , @rest) = map {
                ...
                #            1---1    2---------2
                } elsif (s{\A(\d+)?x\+n([\+\-]\d+)?\Z}{($2 || "0") . " + mRow, " . ($1 || "1")}e  ) {
                } elsif (s{\Ax\Z}{0,1}                                                            ) {
                } elsif (s{\A\-x\Z}{0,-1}                                                         ) {
                } else { # leave single [\+\-]\d+
                }
            ...
            if (! defined($hash{$aseqno})) {
                $hash{$aseqno} = 1;
                $callcode = "uvpol$uv";
                &outstd($aseqno, $a, $b, $c, $d, $e, $f, $uv, "$oa,$ob,$oc,$od,$oe,$of");
            } else {
...
=N=	A208917 u 1....2x...0....2x...2.....1...CEN
=N=	A208918 v 1....2x...0....2x...2.....1...CCNP
...
=N=	A209131 u 1....x+1..0....x....x+1...0...CDEP*
=N=	A209132 v 1....x+1..0....x....x+1...0...CNPZ*
=N=	A209133 u 1....x+1..0....x....x+1...0...CDN
=N=	A209134 v 1....x+1..0....x....x+1...0...CCN*
...
=N=	A209152 u 1....x+1..0....x....x.....1...CN*
=N=	A208339 v 1....x+1..0....x....x.....1...BCN
=N=	A209153 u 1....x+1..0....x....x.....1...CFT*
=N=	A208340 v 1....x+1..0....x....x.....1...FNZ*
...
=N=	A076791 v 1....1....0....1....1.....0...BBCDF      a was x
...
=N=	A209559 u x....1....0....1....2x....1...CN
=N=	A209560 v x....1....0....1....2x....1...CN
...
=N=	A209567 u x....1....0....x....2x....1...CNT*
=N=	A209568 v x....1....0....x....2x....1...NNS*
...
=N=	A209577 u x....1....0....2x...2x....1...CNNT
=N=	A209578 v x....1....0....2x...2x....1...CNN
...
=N=	A209699 u x....x....0....x....x+1...1...BNNZ
=N=	A209700 v x....x....0....x....x+1...1...BDN
...
=N=	A210037 u 1....1....1....1.....2x...1...BCFFN
...
=N=	A210797 u 1....x....1....x+2...x-1..1...CF      has additional factors
=N=	A210798 v 1....x....1....x+2...x-1..1...F       dito
...
=N=	A210803 u 1....x....1....x-1...x+3..0...F*      has additional factors
=N=	A210804 v 1....x....1....x-1...x+3..0...F*      dito
=N=	A210805 u 1....x....0....x+2...x-1..1...CFFN    has additional factors
=N=	A210806 v 1....x....0....x+2...x-1..1...FF      dito
