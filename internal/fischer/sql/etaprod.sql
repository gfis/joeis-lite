-- etaprod.sql
-- @(#) $Id$
-- 2023-01-25: mostly commented out
...
UPDATE seq4 SET parm1 = '[2,8;1,-4]'          WHERE aseqno =  'A008438';
UPDATE seq4 SET parm1 = '[8,2;2,2;4,-1;1,-5]', parm2='-11/24', parm4 = 2, callcode = 'etaprof'  WHERE aseqno =  'A100535';
-- UPDATE seq4 SET parm1 = '[126,1;36,1;28,1;9,1;7,1;2,1;252,-1;63,-1;18,-1;14,-1;4,-1;1,-1]' WHERE aseqno = 'A119952';
