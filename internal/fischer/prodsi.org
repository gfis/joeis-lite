A057863	prodsif	0	FACTORIAL.factorial(2 * k - 1)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (2k-1)!!.
...
A059384	prodsi	1	J_5(i)	for (int i = 1; i <= mN; ++i) {		a(n) = Product_{i=1..n} J_5(i).
A059861	prodsi	1	(prime(i) - 2)	for (int i = 2; i <= mN; ++i) {		a(n) = Product_{i=2..n} (prime(i) - 2).
A059862	prodsi	1	(prime(i) - 3)	for (int i = 3; i <= mN; ++i) {		a(n) = Product_{i=3..n} (prime(i) - 3).
A059863	prodsi	1	(prime(i)-4)	for (int i = 3; i <= mN; ++i) {		a(n) = Product_{i=3..n} (prime(i)-4).
A059864	prodsi	1	(prime(i)-5), where prime(i) is i-th prime	for (int i = 4; i <= mN; ++i) {		a(n) = Product_{i=4..n} (prime(i)-5), where prime(i) is i-th prime.
A066780	prodsi	1	sigma(k); sigma(k) is the sum of the positive divisors of mN	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} sigma(k); sigma(k) is the sum of the positive divisors of n.
A066843	prodsi	1	d(k); d(k) is the number of positive divisors of k	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} d(k); d(k) is the number of positive divisors of k.
...
# A076000	prodsi	1	k/floor(mN/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} k/floor(n/k).
A076265	prodsi	1	prime(i).pow(prime(i)	for (int i = 1; i <= mN; ++i) {		a(n) = Product_{i=1..n} prime(i)^prime(i).
A076954	prodsi	0	prime(i).pow(i	for (int i = 1; i <= mN; ++i) {		a(n) = Product_{i=1..n} prime(i)^i.
A082480	prodsi	0	(F(k)+1) where F(k) denotes the k-th Fibonacci number	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (F(k)+1) where F(k) denotes the k-th Fibonacci number.
A086803	prodsi	1	(prime(mN+1)-prime(i))	for (int i = 2; i <= mN; ++i) {		a(n) = Product_{i=2..n} (prime(n+1)-prime(i)).
A087315	prodsi	0	prime(k).pow(prime(mN-k+1)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} prime(k)^prime(n-k+1).
A090114	prodsi	1	(prime(mN)-j)	for (int j = 1; j <= mN; ++j) {		a(n) = Product_{j=1..n} (prime(n)-j).
...
# A216703	prodsi	0	(49 - 7/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (49 - 7/k).
# A216704	prodsi	0	(64 - 8/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (64 - 8/k).
# A216705	prodsi	0	(81 - 9/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (81 - 9/k).
# A216706	prodsi	0	(100 - 10/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (100 - 10/k).
# A216786	prodsi	0	(121 - 11/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (121 - 11/k).
# A216787	prodsi	0	(144 - 12/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (144 - 12/k).
# A216788	prodsi	0	(169 - 13/k)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (169 - 13/k).
-> A224479	prodsi	0	Product_{i=1..k-1} gcd(k,i)	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} Product_{i=1..k-1} gcd(k,i).
A224986	prodsif	1	FACTORIAL.factorial(mN-k-2)	for (int k = 1; k <= mN - 4; ++k) {		a(n) = Product_{k=1..n-4} (n-k-2)!^(k*k!).
...
A266091	prodsif	0	FACTORIAL.factorial(3*k)!/(mN+k)	for (int k = 0; k <= mN; ++k) {		a(n) = Product_{k=0..n} (3*k)!/(n+k)!.
...
# A324427	prodsi	1	(Product_{j=1..k} (Product_{i=1..j} (i+j+k)))	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} (Product_{j=1..k} (Product_{i=1..j} (i+j+k))).
...
A345466	prodsib	0	Binomial.binomial(mN, floor(mN/k))	for (int k = 1; k <= mN; ++k) {		a(n) = Product_{k=1..n} binomial(n, floor(n/k)).
