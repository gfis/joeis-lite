 ...
 */
public class InfiniteProductTransform extends AbstractSequence {
   ...
   */
  public InfiniteProductTransform() {
   ...
   */
  public InfiniteProductTransform(final int offset, final int kStart) {
   ...
   */
  public InfiniteProductTransform(final int offset, final int kStart, final long[] preTerms) {
    super(offset);
    mSeqF = null;
    mSeqG = null;
  ...
  public Z next() {
    ...
    if (!mFRoot.isZero()) {
      ...
      if (!quotRem[1].isZero()) {
        System.err.println("assertion in InfiniteProductTransform: remainder != 0 for k=" + mKfg);
      }
      bSum = quotRem[0];
    }
/*
