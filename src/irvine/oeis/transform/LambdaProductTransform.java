 ...
 */
public class LambdaProductTransform extends AbstractSequence {
...
//  /**
//    * Builder inner class for flexible argument setup.
//    */
//  public static class LambdaProductBuilder {
...
//  }
  ...
  /**
   * Empty constructor: sequence of partition numbers.
   */
  public LambdaProductTransform() {
    this(0, k -> Z.ONE);
  }
   ...
   */
  public LambdaProductTransform(final int offset, final Function<Integer, Z> lambdaF) {
   ...
   */
  public LambdaProductTransform(final int offset, final Function<Integer, Z> lambdaF, final Function<Integer, Z> lambdaG) {
   ...
   */
  public LambdaProductTransform(final int offset, final Function<Integer, Z> lambdaF, final Function<Integer, Z> lambdaG, final Function<Integer, Z> lambdaH) {
    super(offset);
    final int kStart = 1;
    mLambdaF = lambdaF;
    mLambdaG = lambdaG;
  ...
  public Z next() {
    ...
    if (!mFRoot.isZero()) {
      ...
      if (!quotRem[1].isZero()) {
        System.err.println("assertion in LambdaProductTransform: remainder != 0 for k=" + mKfg);
      }
      bSum = quotRem[0];
    }
/*
