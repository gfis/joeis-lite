...
public class MultiTransformSequence extends AbstractSequence {
  ...
  public final Z[] s; // terms of of the source sequences
  ...
  /**
   * Convenience call for existing target sequence elements.
   * @param n index
   * @return a(n)
   */
   ...
   * until <code>s[ix]</code> contains mSeqs[].a(n), and shift into the <code>PREVIOUS</code>
   * terms appropriately.
