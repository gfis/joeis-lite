...
/* A151255		Number of walks within N^2 (the first quadrant of Z^2) starting 
   at (0,0) and consisting of n steps taken from {(-1, -1), (-1, 1), (1, 0)}
...
*/
   ...
   */
  protected Z aux23(int i, int j, int m) {
    String key = i + "," + j + "," + m;
    ...
    if (result == null) {
      if  (  i > m || j > m 
        ...
        if (key.substring(0, 4).equals("0,0,")) {
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux24(int i, int j, int m) {
    String key = i + "," + j + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m 
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux25(int i, int j, int m) {
    String key = i + "," + j + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m 
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux26(int i, int j, int m) {
    String key = i + "," + j + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m 
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux27(int i, int j, int m) {
    String key = i + "," + j + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m 
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux28(int i, int j, int m) {
    String key = i + "," + j + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m 
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux33(int i, int j, int k, int m) {
    String key = i + "," + j + "," + k + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m || k > m
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux34(int i, int j, int k, int m) {
    String key = i + "," + j + "," + k + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m || k > m
   ...
   * @return number of possible steps starting at this point
   */
  protected Z aux35(int i, int j, int k, int m) {
    String key = i + "," + j + "," + k + "," + m;
    Z result = mCache.get(key);
    if (result == null) {
      if  (  i > m || j > m || k > m
