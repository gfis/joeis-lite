...
public class PolynomialFieldSequence extends AbstractSequence {
  ...
  
  {
    ...
    setPost1(16, "abs"     , (stack, m) -> RING.abs(stack.pop()));
    setPost1(17, "acosh"   , (stack, m) -> RING.acosh(stack.pop(), m));
    setPost1(18, "asin"    , (stack, m) -> RING.asin(stack.pop(), m));
    setPost1(19, "asinh"   , (stack, m) -> RING.asinh(stack.pop(), m));
    setPost1(20, "atan"    , (stack, m) -> RING.atan(stack.pop(), m));
    setPost1(21, "atanh"   , (stack, m) -> RING.atanh(stack.pop(), m));
    setPost1(22, "cos"     , (stack, m) -> RING.cos(stack.pop(), m));
    setPost1(23, "cosh"    , (stack, m) -> RING.cosh(stack.pop(), m));
    setPost1(24, "cot"     , (stack, m) -> RING.series(RING.one(), RING.tan(stack.pop(), m), m));
    setPost1(25, "coth"    , (stack, m) -> RING.series(RING.one(), RING.tanh(stack.pop(), m), m));
    setPost1(26, "csc"     , (stack, m) -> RING.series(RING.one(), RING.sin(stack.pop(), m), m));
    setPost1(27, "csch"    , (stack, m) -> RING.series(RING.one(), RING.sinh(stack.pop(), m), m));
    setPost1(28, "dif"     , (stack, m) -> RING.diff(stack.pop()));
    setPost1(29, "eta"     , (stack, m) -> RING.eta(stack.pop(), m));
    setPost1(30, "exp"     , (stack, m) -> RING.exp(stack.pop(), m));
    setPost1(31, "int"     , (stack, m) -> RING.integrate(stack.pop()).truncate(m));
    setPost1(32, "inv"     , (stack, m) -> RING.inverse(stack.pop()));
    setPost1(33, "lambNegW", (stack, m) -> RING.negate(RING.lambertW(stack.pop(), m)));
    setPost1(34, "lambertW", (stack, m) -> RING.lambertW(stack.pop(), m));
    setPost1(35, "log"     , (stack, m) -> RING.log(stack.pop(), m));
    setPost1(36, "neg"     , (stack, m) -> RING.negate(stack.pop()));
    setPost1(37, "rev"     , (stack, m) -> RING.reversion(stack.pop(), m));
    setPost1(38, "sec"     , (stack, m) -> RING.sec(stack.pop(), m));
    setPost1(39, "sech"    , (stack, m) -> RING.sech(stack.pop(), m));
    setPost1(40, "sin"     , (stack, m) -> RING.sin(stack.pop(), m));
    setPost1(41, "sinh"    , (stack, m) -> RING.sinh(stack.pop(), m));
    setPost1(42, "sqrt"    , (stack, m) -> RING.sqrt(stack.pop(), m));
    setPost1(43, "tan"     , (stack, m) -> RING.tan(stack.pop(), m));
    setPost1(44, "tanh"    , (stack, m) -> RING.tanh(stack.pop(), m));
  }
  ...
  public PolynomialFieldSequence(final int offset, final String polys, final String postfix,
    ...
    mPostLen = 0;
    for (int is = 0; is < mPostStrings.length; ++is) {
      Integer ix = sFunctions.get(mPostStrings[is]);
      if (ix != null) {
